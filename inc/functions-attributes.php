...
add_filter( 'hybrid_attr_header',  'hybrid_base_attr_header',  5    );
add_filter( 'hybrid_attr_footer',  'hybrid_base_attr_footer',  5    );
add_filter( 'hybrid_attr_content', 'hybrid_base_attr_content', 5    );
add_filter( 'hybrid_attr_sidebar', 'hybrid_base_attr_sidebar', 5, 2 );
add_filter( 'hybrid_attr_menu',    'hybrid_base_attr_menu',    5, 2 );

# Header attributes.
add_filter( 'hybrid_attr_head',             'hybrid_base_attr_head',             5 );
add_filter( 'hybrid_attr_branding',         'hybrid_base_attr_branding',         5 );
add_filter( 'hybrid_attr_site-title',       'hybrid_base_attr_site_title',       5 );
add_filter( 'hybrid_attr_site-description', 'hybrid_base_attr_site_description', 5 );

# Archive page header attributes.
add_filter( 'hybrid_attr_archive-header',      'hybrid_base_attr_archive_header',      5 );
add_filter( 'hybrid_attr_archive-title',       'hybrid_base_attr_archive_title',       5 );
add_filter( 'hybrid_attr_archive-description', 'hybrid_base_attr_archive_description', 5 );

# Post-specific attributes.
add_filter( 'hybrid_attr_post',            'hybrid_base_attr_post',            5    );
add_filter( 'hybrid_attr_entry',           'hybrid_base_attr_post',            5    ); // Alternate for "post".
add_filter( 'hybrid_attr_entry-title',     'hybrid_base_attr_entry_title',     5    );
add_filter( 'hybrid_attr_entry-author',    'hybrid_base_attr_entry_author',    5    );
add_filter( 'hybrid_attr_entry-published', 'hybrid_base_attr_entry_published', 5    );
add_filter( 'hybrid_attr_entry-content',   'hybrid_base_attr_entry_content',   5    );
add_filter( 'hybrid_attr_entry-summary',   'hybrid_base_attr_entry_summary',   5    );
add_filter( 'hybrid_attr_entry-terms',     'hybrid_base_attr_entry_terms',     5, 2 );

# Comment specific attributes.
add_filter( 'hybrid_attr_comment',           'hybrid_base_attr_comment',           5 );
add_filter( 'hybrid_attr_comment-author',    'hybrid_base_attr_comment_author',    5 );
add_filter( 'hybrid_attr_comment-published', 'hybrid_base_attr_comment_published', 5 );
add_filter( 'hybrid_attr_comment-permalink', 'hybrid_base_attr_comment_permalink', 5 );
add_filter( 'hybrid_attr_comment-content',   'hybrid_base_attr_comment_content',   5 );
 ...
 * @return array
 */
function hybrid_base_attr_footer( $attr ) {
	$attr['id']        = 'footer';
 ...
 * @return array
 */
function hybrid_base_attr_content( $attr ) {
	$attr['id']       = 'content';
	$attr['class']    = 'content';
	$attr['role']     = 'main';
	if ( ! is_singular( 'post' ) && ! is_home() && ! is_archive() )
 ...
 * @return array
 */
function hybrid_base_attr_sidebar( $attr, $context ) {
	$attr['class'] = 'sidebar';
 ...
 * @return array
 */
function hybrid_base_attr_menu( $attr, $context ) {
	$attr['class'] = 'menu';
 ...
 * @return array
 */
function hybrid_base_attr_head( $attr ) {
	$attr['itemscope'] = 'itemscope';
 ...
 * @return array
 */
function hybrid_base_attr_archive_header( $attr ) {
 ...
 * @return array
 */
function hybrid_base_attr_archive_title( $attr ) {
 ...
 * @return array
 */
function hybrid_base_attr_archive_description( $attr ) {
 ...
 * @return array
 */
function hybrid_base_attr_post( $attr ) {
	$post = get_post();
 ...
 * @return array
 */
function hybrid_base_attr_entry_title( $attr ) {
 ...
 * @return array
 */
function hybrid_base_attr_entry_author( $attr ) {
 ...
 * @return array
 */
function hybrid_base_attr_entry_published( $attr ) {
 ...
 * @return array
 */
function hybrid_base_attr_entry_content( $attr ) {
 ...
 * @return array
 */
function hybrid_base_attr_entry_summary( $attr ) {
 ...
 * @return array
 */
function hybrid_base_attr_entry_terms( $attr, $context ) {
	if ( !empty( $context ) ) {
 ...
 * @return array
 */
function hybrid_base_attr_comment( $attr ) {
 ...
 * @return array
 */
function hybrid_base_attr_comment_author( $attr ) {
 ...
 * @return array
 */
function hybrid_base_attr_comment_published( $attr ) {
 ...
 * @return array
 */
function hybrid_base_attr_comment_permalink( $attr ) {
 ...
 * @return array
 */
function hybrid_base_attr_comment_content( $attr ) {
