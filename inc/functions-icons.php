 ...
 */
function hybrid_base_get_font_icon_code( $name ) {

	$icons = hybrid_base_get_font_icons();
 ...
 */
function hybrid_base_get_font_icon_text( $name ) {

	$icon = hybrid_base_get_font_icon_code( $name );
 ...
 */
function hybrid_base_get_font_icon_html( $name ) {
 ...
 */
function hybrid_base_get_font_icon_css( $name ) {
	$icon = hybrid_base_get_font_icon_code( $name );
	return $icon ? "\\{$icon}" : '';
}
 ...
 */
function hybrid_base_font_icon_exists( $name ) {
 ...
 */
function hybrid_base_validate_font_icon( $icon ) {

	return hybrid_base_font_icon_exists( $icon ) ? $icon : '';
}
 ...
 */
function hybrid_base_get_font_icons() {
	...
	return apply_filters( 'hybrid_base_font_icons', $icons );
}
